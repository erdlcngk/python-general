# -*- coding: utf-8 -*-
"""
Created on Wed Mar 23 18:22:43 2022
...
coin_blur = cv2.GaussianBlur(coin, (7,7), 30)
...
# binary threshold
ret, coin_thresh = cv2.threshold(coin_gray, 100, 110, cv2.THRESH_BINARY)
