# -*- coding: utf-8 -*-
"""
Created on Sat Mar 19 13:16:51 2022
...
plt.figure(), plt.imshow(golden_gate_vis), plt.axis("off"), plt.title("orijinal golden gate")
